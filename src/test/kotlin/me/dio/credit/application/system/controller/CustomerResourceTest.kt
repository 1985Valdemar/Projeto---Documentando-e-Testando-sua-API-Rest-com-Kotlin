...
class CustomerResourceTest {
  ...
  fun `should create a customer and return 201 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Val"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Teider"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("123456789"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("teider@email.com"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da Teider, 123"))
  ...
  fun `should update a customer and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.status().isOk)
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("ValUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("TeiderUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("123456789"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("teider@email.com"))
  ...
  private fun builderCustomerDto(
    ...
    lastName: String = "Teider",
    cpf: String = "123456789",
    email: String = "teider@email.com",
    income: BigDecimal = BigDecimal.valueOf(1000.0),
    password: String = "123456",
    zipCode: String = "000000",
    street: String = "Rua da Teider, 123",
  ) = CustomerDto(
    firstName = firstName,
    lastName = lastName,
    cpf = cpf,
  ...
  private fun builderCustomerUpdateDto(
    firstName: String = "ValUpdate",
    lastName: String = "TeiderUpdate",
